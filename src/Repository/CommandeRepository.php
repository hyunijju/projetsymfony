...
class CommandeRepository extends ServiceEntityRepository
{
    ...
    public function listeVehiculesLoues($dtDebutResa , $dtFinResa):array{
        $resultat = [];
        $vehiculeReserve =  $this->createQueryBuilder('c')
                    ...
                    ->getResult()
                ;
        foreach($vehiculeReserve as $vehicule){
    ...
    public function vehiculesDisponibles($dtDebutResa , $dtFinResa){
        $reserves = $this->listeVehiculesLoues($dtDebutResa , $dtFinResa);
        // dump($reserves);
